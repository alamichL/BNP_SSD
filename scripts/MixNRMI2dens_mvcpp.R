...
MixNRMI2dens_mvcpp = function (x, probs = c(0.025, 0.5, 0.975), Alpha = 1, Beta = 0,
...
#   rk : distr = 5 : lnorm
  ...
  # for (j in 1:1000) {
    ...
    Fxx[, j] <- fcondXA2(xx, distr = distr.k, Tauy, Tauz, J)
...
environment(MixNRMI2dens_mvcpp) <- environment(MixNRMI2)
